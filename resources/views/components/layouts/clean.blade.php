...
<body class="min-h-screen font-sans antialiased bg-base-200/50 dark:bg-base-200" style="background-image: url('../fishing-blurred-background.webp'); background-size: cover; background-position: center;
  background-attachment: fixed;">
  {{-- <img id="background" class="fixed left-0 top-0 w-full h-auto" src="../background2.svg" /> --}}
  <x-main>
    <x-slot:content>
      <div class="mx-auto bg-slate-900 bg-opacity-50 backdrop-blur-sm rounded-lg shadow-sm shadow-black p-4">
